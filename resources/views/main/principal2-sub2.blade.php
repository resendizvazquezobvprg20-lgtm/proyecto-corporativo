...
@extends('layouts.app')
@section('title','Principal 2.2')
@section('page-title','Principal 2 — Submenú 2')
...
@php
    ...
    $p  = $ea
        ...
        : (PermisoPerfil::where('idPerfil',$um->idPerfil)->where('idModulo',8)->first()?->toArray() ?? []);
@endphp

<div class="card">
    <div class="card-header"><i class="bi bi-layers me-2"></i>Principal 2 — Sub 2</div>
    <div class="card-body">
        ...
        <div class="alert alert-info">
            <i class="bi bi-info-circle me-2"></i>Pantalla estática — Sub 2 del menú Principal 2.
        </div>
    </div>
</div>
@endsection
